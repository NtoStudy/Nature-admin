<template>
  <div class="add-func-dialog">
    <el-dialog v-model="dialogVisible" :title="dialogTitle" :close-on-click-modal="false" @closed="handleClosed">
      <el-form
        ref="formRef"
        :model="formMdl"
        ...
        <el-row :gutter="35">
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12" class="mb-[5px]">
            <el-form-item prop="parentName" label="父级功能">
              <el-input v-model="formMdl.parentName" disabled clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12" class="mb-[5px]">
            <el-form-item label="功能名称" prop="title">
              <el-input v-model="formMdl.title" placeholder="请输入功能名称" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12" class="mb-[5px]">
            <el-form-item label="功能类型" prop="type">
              <el-select v-model="formMdl.type" placeholder="请选择" clearable class="w-[100%]">
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12" class="mb-[5px]">
            <el-form-item label="状态" prop="status">
              <el-select v-model="formMdl.status" placeholder="请选择功能状态" clearable class="w-[100%]">
                <el-option v-for="item in FUNC_STATUS" :key="item.value" :label="item.label" :value="item.value" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12" class="mb-[5px]">
            <el-form-item label="页面路由" prop="path">
              <el-input v-model="formMdl.path" placeholder="页面路由" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12" class="mb-[5px]">
            <el-form-item label="唯一标识" prop="code">
              <el-input v-model="formMdl.code" placeholder="请输入功能唯一标识" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12" class="mb-[5px]">
            <el-form-item label="icon" prop="icon">
              <el-input v-model="formMdl.icon" placeholder="请输入icon名称" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12" class="mb-[5px]">
            <el-form-item label="排序值" prop="sort">
              <el-input v-model="formMdl.sort" placeholder="请输入排序值" clearable></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
      ...
      <template v-if="!isDetailMode" #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" :loading="loadding" @click="handleSubmit"> 确认 </el-button>
        </span>
      </template>
    </el-dialog>
  </div>
  ...
  sort: [
    {
      ...
      validator: (rule, value, callback) => {
        if (!isNullOrUnDef(value) && value !== '' && !isPositiveInteger(value)) {
...
// 打开弹窗 - 必须在 defineExpose 之前定义
const open = () => {
  dialogVisible.value = true
}

// 关闭弹窗 - 必须在 defineExpose 之前定义
const close = () => {
  dialogVisible.value = false
}

// 在定义了所有要暴露的方法后，再使用 defineExpose
defineExpose({ open, close, formMdl })
