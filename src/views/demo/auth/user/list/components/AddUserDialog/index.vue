      ...
      <el-col :xs="24" :sm="22" :md="12" :lg="20" :xl="20">
        ...
        >
          <el-form-item prop="account" label="账号">
            <el-input v-model="formMdl.account" :maxlength="30" placeholder="请输入账号" clearable></el-input>
          </el-form-item>

          <el-form-item prop="department" label="所属部门">
            <el-select v-model="formMdl.department" placeholder="请选择所属部门" clearable>
              <el-option v-for="item in DEPARTMENTS" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>

          <el-form-item prop="roleIds" label="角色">
            <el-select v-model="formMdl.roleIds" placeholder="请选择角色" multiple clearable>
              <el-option v-for="item in ROLES" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>

          <el-form-item prop="status" label="账号状态">
            <el-select v-model="formMdl.status" placeholder="请选择账号状态" clearable>
              <el-option v-for="item in ACCOUNT_STATUS" :key="item.value" :label="item.label" :value="item.value" />
            </el-select>
          </el-form-item>
        </el-form>
      </el-col>
