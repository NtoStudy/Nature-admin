          ...
          children: [
            {
              ...
              component: () => import('@/views/demo/components/base/table/configurableTable/index.vue'),
            },
            {
              ...
              component: () => import('@/views/demo/components/base/table/customTable/index.vue'),
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              component: () => import('@/views/demo/components/base/form/dynamicForm/index.vue'),
            },
            {
              ...
              component: () => import('@/views/demo/components/base/form/stepForm/index.vue'),
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              component: () => import('@/views/demo/components/base/column/columnAndList/index.vue'),
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              component: () => import('@/views/demo/components/base/tree/lineTree/index.vue'),
            },
          ],
        },
      ],
